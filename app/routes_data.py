...
SATURDAY_ROUTES = {
    "arrival": {
        ...
        "stops_by_route": {
            ...
            "San Pedro-Sábado 9:00AM": [
                "Calle JOSE HAZIM AZAR (Frente al Supermercado JUMBO)",
                "Calle Luis Amiama Tio (Frente a la Bomba shell)",
                "AV. F. A. Caamaño D (Frente al Banco Popular) de la UCE",
                "AV. F. A. Caamaño D ( Frente a la clínica del niño)",
                "AVE. INDEPENDENCIA (después de cruzar frente a McDonald)",
                "AV. Mauricio Baez (Despues en el parquesito de los mudos)",
                "AV. Laureano Canto (Parque de la biblia - Estadio Tetelo Vargas)",
                "Calle Simon Bolivar (Bomba Petronan)",
                "Calle Maximiliano Gomes (En la importadora Oriang)",
                "C. Maria Antonia Q. (Puente peatonal, frente al destacamento)",
                "AUTOPISTA LAS AMERICAS (Boca Chica, frente a los Bomberos)",
                "AUTOPISTA LAS AMERICAS (Frente a la parada de Boca Chica)",
                "AUTOPISTA LAS AMERICAS (Puente Peatonal frente a Claro)",
                "AUTOPISTA LAS AMERICAS (Vistas de Caucedo, debajo del elevado.)",
